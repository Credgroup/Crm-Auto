...
const columnsHistoric: ColumnDef<HistoricoProdutoItem>[] = [
    {
        ...
        cell: ({}) => {
            return (
                <HoverCard>
                <HoverCardTrigger>
                    <p className="hover:underline">Id do disparo</p>
                </HoverCardTrigger>
                <HoverCardContent className="flex items-center gap-4 w-fit py-2">
                    <p className="text-sm">Id do shortlink</p>
                    <Button
                    size="icon"
                    className="aspect-square"
                    variant="ghost"
                    onClick={() => copyToClipboard("Id do disparo")}
                    >
                        <LuCopy />
                    </Button>
                </HoverCardContent>
    ...
    return (
        <>
            <div className="flex items-center space-x-2 mb-8">
                <p className="font-medium text-xl">Disparos do Produto</p>
            </div>
