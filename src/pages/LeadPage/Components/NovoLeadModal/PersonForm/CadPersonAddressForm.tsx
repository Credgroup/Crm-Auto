...
import { PersonWithAdicional } from ".";
...
type CadPersonAddressFormProps = {
  person: Partial<PersonWithAdicional | null>;
  setPerson: Dispatch<SetStateAction<Partial<PersonWithAdicional> | null>>;
  setFormController: () => void;
};

export default function CadPersonAddressForm({
  person,
  setPerson,
  setFormController,
}: Readonly<CadPersonAddressFormProps>) {
  ...
  const onSubmit = (data: Inputs) => {
    ...
    setPerson({ ...person, adicional: personData });
  };
