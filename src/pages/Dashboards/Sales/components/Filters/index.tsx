...
export default function Filters({filters, setFilters}: Readonly<FiltersProps>) {
    ...
    const handleSearch = async () => {
      ...
      try {
        ...
        await queryClient.invalidateQueries({ queryKey: ["AnalyticsProductSales"] });
        await queryClient.invalidateQueries({ queryKey: ["AnalyticsSellerSales"] });
        await queryClient.invalidateQueries({ queryKey: ["SalesCockpit"] });
        await queryClient.invalidateQueries({ queryKey: ["RecentSalesData"] });
    ...
    const getSearchTooltip = () => {
      ...
      return hasSearched ? "Atualizar dados" : "Buscar dados";
    };
